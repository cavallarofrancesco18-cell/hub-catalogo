               ...
               <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" placeholder="Es. 110" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input type="number" placeholder="Es. 1998" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
               ...
               <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Es. Euro 6d" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                />
                 <FormField
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                        <Input placeholder="Es. Pagato fino a 12/2024" {...field} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    )}
